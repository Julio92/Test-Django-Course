...
SECRET_KEY = 'django-insecure-mn8&+ft+meig0(xn*xe+=*8q32tchj%9&y1rlwy4ifget#qf$('
...
# Auth redirects
# LOGIN_REDIRECT_URL = 'pages:pages' Ya no lo necesitamos, porque hemos creado un profile.
